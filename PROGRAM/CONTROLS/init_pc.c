...
void ExternControlsInit(bool bFirst)
{
	...
	CI_CreateAndSetControls( "", "TimeScalePlus", CI_GetKeyCode("VK_ADD"), 0, true );
	CI_CreateAndSetControls( "", "TimeScaleMinus", CI_GetKeyCode("VK_SUBTRACT"), 0, true );
...
// Character ===================================================================
	...
	if(LanguageGetLanguage()=="french") {
		CI_CreateAndSetControls( "FightModeControls", "ChrRecoil", CI_GetKeyCode("KEY_W"), 0, true );
	} else {
	...
	if(LanguageGetLanguage()=="french") {
		CI_CreateAndSetControls( "FightModeControls", "ChrFire", CI_GetKeyCode("KEY_A"), 0, true );
	} else {
...
// Ship ========================================================================
	if(LanguageGetLanguage()=="french") {
		CI_CreateAndSetControls( "Sailing3Pers", "Ship_TurnLeft", CI_GetKeyCode("KEY_Q"), 0, true );
	} else {
	...
	if(LanguageGetLanguage()=="french") {
		CI_CreateAndSetControls( "Sailing3Pers", "Ship_SailUp", CI_GetKeyCode("KEY_Z"), 0, true );
	} else {
...
// World map ===================================================================
	...
	CI_CreateAndSetControls( "WorldMapControls", "WMapPauseSwitch", CI_GetKeyCode("KEY_P"), 0, true );
	if(LanguageGetLanguage()=="french") {
		CI_CreateAndSetControls( "WorldMapControls", "WMapShipSailUp", CI_GetKeyCode("KEY_Z"), 0, true );
	} else {
	...
	if(LanguageGetLanguage()=="french") {
		CI_CreateAndSetControls( "WorldMapControls", "WMapShipTurnLeft", CI_GetKeyCode("KEY_Q"), 0, true );
	} else {
...
// Interface ===================================================================
	...
	MapControlToGroup("hk_charge4","BattleInterfaceControls");
		// other hot keys
	CI_CreateAndSetControls( "PrimaryLand", "hk_Cure", CI_GetKeyCode("KEY_C"), 0, true );
	MapControlToGroup("hk_Cure","FightModeControls");
	MapControlToGroup("hk_Cure","BattleInterfaceControls");
		//
	CI_CreateAndSetControls( "PrimaryLand", "hk_Rush", CI_GetKeyCode("KEY_0"), 0, true );
	MapControlToGroup("hk_Rush","FightModeControls");
	MapControlToGroup("hk_Rush","BattleInterfaceControls");
		//
	CI_CreateAndSetControls( "Sailing3Pers", "hk_ImmediateReload", CI_GetKeyCode("KEY_9"), 0, true );
	MapControlToGroup("hk_ImmediateReload","Sailing1Pers");
	MapControlToGroup("hk_ImmediateReload","BattleInterfaceControls");
		//
	CI_CreateAndSetControls( "Sailing3Pers", "hk_LightRepair", CI_GetKeyCode("KEY_8"), 0, true );
	MapControlToGroup("hk_LightRepair","Sailing1Pers");
	MapControlToGroup("hk_LightRepair","BattleInterfaceControls");
		//
	CI_CreateAndSetControls( "Sailing3Pers", "hk_InstantRepair", CI_GetKeyCode("KEY_7"), 0, true );
	MapControlToGroup("hk_InstantRepair","Sailing1Pers");
	MapControlToGroup("hk_InstantRepair","BattleInterfaceControls");
		//
	CI_CreateAndSetControls( "Sailing3Pers", "hk_Turn180", CI_GetKeyCode("KEY_6"), 0, true );
	MapControlToGroup("hk_Turn180","Sailing1Pers");
	MapControlToGroup("hk_Turn180","BattleInterfaceControls");
		//
	CI_CreateAndSetControls( "Sailing3Pers", "hk_SandbankManeuver", CI_GetKeyCode("KEY_5"), 0, true );
	MapControlToGroup("hk_SandbankManeuver","Sailing1Pers");
	MapControlToGroup("hk_SandbankManeuver","BattleInterfaceControls");
