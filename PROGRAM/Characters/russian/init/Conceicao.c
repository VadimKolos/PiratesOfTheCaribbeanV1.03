...
int CreateConceicaoCharacters(int n)
{
	...
	makeref(ch, Characters[n]);			// PortugalLineQuestSoldier
	ch.name = "Солдат";
	ch.lastname = "";
	ch.id = "PortugalQuestSoldier";
	...
	ch.location.locator = "";
	ch.Dialog.Filename = "PortugalQuestSoldier.c";
	...
	makeref(ch, Characters[n]);			// amanda
	ch.name = "Аманда";
	ch.lastname = "Медейруш";
	ch.id = "Amanda";
	ch.model = "towngirl7";
	...
	ch.location.group = "";
	ch.location.locator = "";
	ch.Dialog.Filename = "Amanda_dialog.c";
...
// Smugglers_Tavern:
	...
	LAi_SetMerchantType(ch);
	LAi_RemoveLoginTime(ch);
	LAi_SetHP(ch, 128.0, 128.0);
	LAi_group_MoveCharacter(ch, "SMUGGLERS_CITIZENS");
	ch.Ship.Name = "Бесстрашный";
