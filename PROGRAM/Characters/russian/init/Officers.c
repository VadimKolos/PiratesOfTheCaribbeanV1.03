...
int CreateOfficersCharacters(int n)
{
	...
	ch.skill.Sneak = "1";
	ch.money = "0";
	ch.abordage_enable = "false";
	ch.perks.list.LongRangeShoot = true;
	ch.Ship.Name = "Раскаянье";
	...
	ch.homestate = "sit";
	ch.Dialog.Filename = "Clair Larrouse_dialog.c";
	ch.rank 	= 6;
	ch.reputation = "42";
	TakeNItems(ch,"potion1", Rand(4)+1);
