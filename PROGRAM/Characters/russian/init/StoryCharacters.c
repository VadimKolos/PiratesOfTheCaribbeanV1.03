...
//Soldiers that occupy Oxbay replacing English guards.
	...
	makeref(ch, Characters[n]);		//капитан яхты Бена Валлийца
	ch.name = "Джеймс";
	ch.lastname = "Робинсон";
	ch.id = "YachtCadwallonCaptain";
	ch.nation = ENGLAND;
	ch.model = "corsair1";
	ch.sound_type = "pirate";
	ch.sex = "man";
	...
	ch.skill.Sneak = "1";
	ch.money = "8500";
	ch.Ship.Name = "Кадваллон";
	ch.Ship.Type = SHIP_YACHT_ENGLAND;
	ch.Ship.Stopped = true;
	ch.Ship.Cannons.Type = CANNON_TYPE_CULVERINE_LBS12;
	ch.ShipSlot1.Type = SHIP_NOTUSED;
	ch.ShipSlot1.Name = "NoName";
	...
	ch.name 	= "Моряк с корабля Натаниэля";
	ch.lastname 	= "";
	...
	ch.skill.Sneak = "1";
	ch.money = "1000000";
	ch.Ship.Name = "Кокобрилло Сангре";
