...
int CreateTempQuestCharacters(int n)
{
	...
	makeref(ch,Characters[n]);			// quest_smuggler_02
	ch.name 	= "Контрабандист";
	ch.lastname 	= "";
