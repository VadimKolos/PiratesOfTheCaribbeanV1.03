//nclude "DIALOGS\Antoine Lebretton_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "node_1":
			...
			Dialog.text = pcharrepphrase(DLG_TEXT[6] + NPChar.name + " " + NPChar.lastname + DLG_TEXT[7], DLG_TEXT[8]);
		...
		case "room":
			if(Pchar.quest.main_line == "GetAGramotaFromBerangere" && !LAi_IsDead(characterFromID("Amiel Berangere")) && !LAi_IsDead(characterFromID("Virgile Boon")) && !CheckCharacterItem(Pchar,"Story_Gramota"))
			{
		...
		case "rumours_1":
			...
			{
				Link.l2 = DLG_TEXT[59] + Characters[GetCharacterIndex(DLG_TEXT[60])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[61])].lastname + DLG_TEXT[62];
				Link.l2.go = "Teodoro";
				iTest = iTest + 1;
			}
			...
			{
				link.l4 = DLG_TEXT[64] + Characters[GetCharacterIndex(DLG_TEXT[65])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[66])].lastname + DLG_TEXT[67];
			...
			{
				link.l6 = DLG_TEXT[69] + Characters[GetCharacterIndex(DLG_TEXT[70])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[71])].lastname + DLG_TEXT[72];
			...
			{
				link.l7 = DLG_TEXT[74] + characters[GetCharacterIndex(DLG_TEXT[75])].name + " " + characters[GetCharacterIndex(DLG_TEXT[76])].lastname + DLG_TEXT[77];
				...
				else
				{
					...
					else
					{
						...
						if (randomGod == 1)
						{
							...
							link.l1 = DLG_TEXT[88];
							link.l1.go = "exit";
							pchar.quest.destination = "Falaise_de_Fleur_port_01";
		...
		case "Story_AskAboutBerangere_Artem":
			...
			dialog.text = DLG_TEXT[91] + address_form.fra + DLG_TEXT[92];
			link.l1 = DLG_TEXT[93];
		...
		case "Story_AskAboutBerangere_Artem_3":
			...
			dialog.text = DLG_TEXT[96] + address_form.fra + DLG_TEXT[97];
			link.l1 = DLG_TEXT[98];
		...
		case "Story_AskAboutBerangere_Artem_4":
			...
			dialog.text = DLG_TEXT[99] + characters[GetCharacterIndex(DLG_TEXT[100])].name + DLG_TEXT[101] + characters[GetCharacterIndex(DLG_TEXT[102])].lastname + DLG_TEXT[103];
			link.l1 = DLG_TEXT[104] + characters[GetCharacterIndex(DLG_TEXT[105])].name + DLG_TEXT[106];
		...
		case "baldewyn_1":
			...
			dialog.text = DLG_TEXT[109] + Address_Form.Fra + DLG_TEXT[110] + Characters[GetCharacterIndex(DLG_TEXT[111])] + DLG_TEXT[112];
		...
		case "baldewyn_2":
			if (pchar.reputation > 40)
			{
				...
				dialog.text = DLG_TEXT[114] + Address_Form.Fra + DLG_TEXT[115] + Characters[GetCharacterIndex(DLG_TEXT[116])].name + DLG_TEXT[117];
			...
			else
			{
				...
				dialog.text = DLG_TEXT[119] + Characters[GetCharacterIndex(DLG_TEXT[120])]. name + DLG_TEXT[121];
		...
		case "baldewyn_4":
			...
			dialog.text = DLG_TEXT[126] + Address_Form.Fra + DLG_TEXT[127];
		...
		case "teodoro_4":
			...
			Dialog.text = DLG_TEXT[144] + Characters[GetCharacterIndex(DLG_TEXT[145])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[146])].lastname + DLG_TEXT[147];
			Link.l1 = DLG_TEXT[148] + Characters[GetCharacterIndex(DLG_TEXT[149])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[150])].lastname + DLG_TEXT[151];
			Link.l1.go = "teodoro_5";
		break;

		case "teodoro_5":
			dialog.snd = "Voice\ANLE\ANLE033";
			Dialog.Text = DLG_TEXT[152] + Address_Form.Fra + DLG_TEXT[153];
		...
		case "Second time":
			...
			Dialog.text = DLG_TEXT[158] + Address_Form.Fra + DLG_TEXT[159];
		...
		case "smugglers_1":
			...
			Dialog.text = DLG_TEXT[171] + Address_Form.Fra + DLG_TEXT[172];
		...
		case "bukaner_2":
			...
			dialog.text = DLG_TEXT[184] + Address_form.fra + DLG_TEXT[185];
		...
		case "Story_AskAboutBerangere":
			...
			dialog.text = DLG_TEXT[195] + Characters[GetCharacterIndex(DLG_TEXT[196])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[197])].lastname + DLG_TEXT[198];
		...
		case "Story_Berangere_killed_2":
			...
			dialog.text = DLG_TEXT[207] + PChar.name + DLG_TEXT[208];
		...
		case "Story_Berangere_killed_3":
			...
			dialog.text = DLG_TEXT[211] + PChar.name + DLG_TEXT[212];
		...
		case "Story_Berangere_killed_6":
			...
			dialog.text = DLG_TEXT[222] + (11 - PChar.skill.commerce)*200 + DLG_TEXT[223];
			link.l1 = DLG_TEXT[224];
			link.l1.go = "Story_Berangere_killed_5";
			if(makeint(PChar.money) >= ((11 - PChar.skill.commerce)*200))
			{
		...
		case "Story_Berangere_killed_8":
			...
			dialog.text = DLG_TEXT[228] + address_form.fra + DLG_TEXT[229];
		...
		case "Story_Berangere_killed_9":
			...
			dialog.text = DLG_TEXT[231] + address_form.fra + DLG_TEXT[232];
			link.l1 = DLG_TEXT[233] + NPChar.name + DLG_TEXT[234];
			link.l1.go = "Story_exit";
		break;

		case "Story_Berangere_killed_10":
			dialog.snd = "Voice\ANLE\ANLE059";
			AddMoneytoCharacter(Pchar, -(11 - PChar.skill.commerce)*200);
		...
		case "Story_Berangere_killed_11":
			...
			dialog.text = DLG_TEXT[237] + address_form.fra + DLG_TEXT[238];
		...
		case "Story_Berangere_killed_13":
			...
			dialog.text = DLG_TEXT[242] + Characters[GetCharacterIndex(DLG_TEXT[243])].lastname + DLG_TEXT[244] + Characters[GetCharacterIndex(DLG_TEXT[245])].name + DLG_TEXT[246] ;
		...
		case "Berangere_got_a_room_2":
			...
			dialog.text = DLG_TEXT[264] + address_form.fra + DLG_TEXT[265];
