...
//nclude "DIALOGS\Clair Larrouse_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "hire":
			...
			link.l1 = DLG_TEXT[62] + npchar.name + DLG_TEXT[63];
			link.l1.go = "exit";
		...
		case "abordage":
			...
			{
				link.l10 = DLG_TEXT[80];
			}
			else
			{
				link.l10 = DLG_TEXT[81];
			}
