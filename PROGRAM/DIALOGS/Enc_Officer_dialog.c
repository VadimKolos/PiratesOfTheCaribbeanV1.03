...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "hired":
			...
			Link.l3 = DLG_TEXT[33];
			Link.l3.go = "abordage";
			if (checkAttribute(&locations[FindLocation("Conceicao_Shipyard")], "models.day.fd"))
			{
				deleteAttribute(&locations[FindLocation("Conceicao_Shipyard")], "models.day.fd");
				deleteAttribute(&locations[FindLocation("Conceicao_Shipyard")], "models.night.fn");
			}
			if(!checkattribute(&ChrPerksList, "list.MusketsShoot"))
			{
