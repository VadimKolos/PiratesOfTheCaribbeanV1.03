...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "quest lines":
			...
			{
				link.l2 = DLG_TEXT[20];
				link.l2.go = "ANIMISTS_letter";
			}
			if (CheckQuestAttribute("ANIMISTS", "letter_to_father_bernard"))
			{
				link.l2 = DLG_TEXT[21];
				link.l2.go = "letter_to_father_bernard";
			}
			if (CheckQuestAttribute("ANIMISTS", "kill_all_ANIMISTS_in_church"))
			{
				...
				link.l2 = DLG_TEXT[25];
				link.l2.go = "kill_all_ANIMISTS_in_church";
			}
			if (CheckQuestAttribute("ANIMISTS", "to_prison_for_teacher"))
			{
				link.l2 = DLG_TEXT[26];
				link.l2.go = "to_prison_for_teacher";
			}
