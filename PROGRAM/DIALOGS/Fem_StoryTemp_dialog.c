//nclude "DIALOGS\Fem_StoryTemp_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FirstOnQuebradas_4":
			d.Text = DLG_TEXT[14] + Characters[getCharacterIndex(DLG_TEXT[15])].name + DLG_TEXT[16];
			Link.l1 = DLG_TEXT[17];
		...
		case "FirstOnQuebradas_7":
			diag.Tempnode = "NothingTalk";
			d.Text = DLG_TEXT[26] + address_form.eng + DLG_TEXT[27];
			Link.l1 = DLG_TEXT[28];
			Link.l1.go = "Exit";						
		break;			
