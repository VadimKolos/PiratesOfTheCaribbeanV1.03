//nclude "DIALOGS\Greenford Soldier_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "return_idol_from_greenford_soldier_5":
			...
			dialog.text = DLG_TEXT[30] + address_form.eng + DLG_TEXT[31];
			link.l1 = DLG_TEXT[32];
		...
		case "researcher_2":
			...
			dialog.text = DLG_TEXT[51] + address_form.eng + DLG_TEXT[52];
			link.l1 = DLG_TEXT[53];
		...
		case "researcher_3":
			...
			dialog.text = DLG_TEXT[54] + address_form.eng + DLG_TEXT[55];
			link.l1 = DLG_TEXT[56];
		...
		case "researcher_7":
			...
			dialog.text = DLG_TEXT[63] + address_form.eng + DLG_TEXT[64];
		...
		case "researcher_money":
			...
			dialog.text = DLG_TEXT[68] + address_form.eng + DLG_TEXT[69];
			link.l1 = DLG_TEXT[70];
		...
		case "researcher_money_2":
			...
			dialog.text = DLG_TEXT[72] + address_form.eng + DLG_TEXT[73];
			link.l1 = DLG_TEXT[74];
		...
		case "researcher_leadership":
			...
			dialog.text = DLG_TEXT[75] + address_form.eng + DLG_TEXT[76];
			link.l1 = DLG_TEXT[77];
		...
		case "research_leadership_2":
			...
			dialog.text = DLG_TEXT[78] + address_form.eng + DLG_TEXT[79];
			link.l1 = DLG_TEXT[80];
			link.l1.go = "research_exit";
		break;
		...
		case "drink_2":
			...
			dialog.text = DLG_TEXT[83] + address_form.eng + DLG_TEXT[84];
			link.l1 = DLG_TEXT[85];
