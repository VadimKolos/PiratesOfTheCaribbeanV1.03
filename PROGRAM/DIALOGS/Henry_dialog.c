...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "node_2":
			...
			{	
				...
				d.Text = DLG_TEXT[8] + Address_Form.Eng + DLG_TEXT[9];
				Link.l1 = DLG_TEXT[10];
				Link.l1.go = "Node_3";
				Link.l2 = DLG_TEXT[11];
				Link.l2.go = "exit";
		...
		case "Node_3":
			...
			d.Text = DLG_TEXT[15] + Address_Form.Eng + DLG_TEXT[16];
			Link.l1 = DLG_TEXT[17];
			Link.l1.go = "node_5";
			Link.l2 = DLG_TEXT[18];
			Link.l2.go = "node_6";
		...
		case "Node_4":
			...
			{	
				...
				d.Text = DLG_TEXT[20] + Address_Form.Eng + DLG_TEXT[21];
				Link.l1 = DLG_TEXT[22];
				Link.l1.go = "exit";
				Link.l2 = DLG_TEXT[23];
				Link.l2.go = "node_7";
		...
		case "Node_5":
			...
			d.Text = DLG_TEXT[27] + Address_Form.eng + DLG_TEXT[28];
			Link.l1 = DLG_TEXT[29];
			Link.l1.go = "node_8";
			Link.l2 = DLG_TEXT[30];
			Link.l2.go = "node_9";
		...
		case "Node_6":
			...
			d.Text = DLG_TEXT[32] + Address_Form.Eng + DLG_TEXT[33];
			Link.l1 = DLG_TEXT[34];
			Link.l1.go = "exit";
			Link.l2 = DLG_TEXT[35];
			Link.l2.go = "node_11";
		...
		case "node_7":
			...
			d.Text = DLG_TEXT[36] + Address_Form.Eng;
			Link.l1 = DLG_TEXT[37];
			Link.l1.go = "node_5";
			Link.l2 = DLG_TEXT[38];
			Link.l2.go = "node_6";
		...
		case "Node_9":
			...
			d.Text = DLG_TEXT[44] + Address_Form.Eng + DLG_TEXT[45] + Address_Form.Eng + DLG_TEXT[46];
			Link.l1 = DLG_TEXT[47];
			Link.l1.go = "node_8";
			Link.l2 = DLG_TEXT[48];
			Link.l2.go = "node_10";
		...
		case "Node_10":
			...
			d.Text = DLG_TEXT[50] + Address_Form.Eng + DLG_TEXT[51];
			Link.l1 = DLG_TEXT[52];
			Link.l1.go = "node_9";
			Link.l2 = DLG_TEXT[53];
			Link.l2.go = "node_8";
		...
		case "Node_11":
			...
			d.Text = RandQuestSum  + DLG_TEXT[55] + Address_Form.Eng + DLG_TEXT[56];
			Link.l1 = DLG_TEXT[57];
			Link.l1.go = "node_12";
			Link.l2 = DLG_TEXT[58];
			Link.l2.go = "exit";
		...
		case "Node_12":
			if(makeint(PChar.money)>=RandQuestSum)
			{
				...
				d.Text = DLG_TEXT[59] + Address_Form.Eng + DLG_TEXT[60];
				Link.l1 = DLG_TEXT[61];
				Link.l1.go = "node_13";
				Link.l2 = DLG_TEXT[62];
				Link.l2.go = "exit";
			...
			else
			{
				...
				d.Text = DLG_TEXT[63] + Pchar.name + DLG_TEXT[64];
				link.l1 = DLG_TEXT[65];
				link.l1.go = "node_11";
			}
		...
		case "Node_13":
			...
			d.Text = DLG_TEXT[66] + Address_Form.Eng + DLG_TEXT[67];
			Link.l1 = DLG_TEXT[68];
			Link.l1.go = "node_14";
			Link.l2 = DLG_TEXT[69];
			Link.l2.go = "exit";
	...
	//Диалог второй - игрок уже встречался с Генри, но не заплатил ему за информацию.
		...
		case "Node_15":
			...
			d.Text = RandPhrase(DLG_TEXT[72] + Address_Form.Eng + DLG_TEXT[73], DLG_TEXT[74], Address_Form.Eng + DLG_TEXT[75], &dialog, dialog.snd1, dialog.snd2, dialog.snd3);
			Link.l1 = DLG_TEXT[76];
			Link.l1.go = "exit";
			Link.l2 = DLG_TEXT[77];
			Link.l2.go = "Node_16";
		...
		case "Node_16":
			if(makeint(PChar.money)>=1)
			{
				...
				d.Text = DLG_TEXT[79] + Address_Form.Eng + DLG_TEXT[80];
				Link.l1 = DLG_TEXT[81];
				Link.l1.go = "node_17";
				Link.l2 = DLG_TEXT[82];
				Link.l2.go = "exit";
			...
			else
			{
				...
				d.Text = DLG_TEXT[83] + Pchar.name + DLG_TEXT[84];
				link.l1 = DLG_TEXT[85];
				link.l1.go = "Node_15";
			}
		...
		case "Node_17":
			...
			d.Text = DLG_TEXT[86] + Address_Form.Eng + DLG_TEXT[87];
			Link.l1 = DLG_TEXT[88];
			Link.l1.go = "node_19";
			Link.l2 = DLG_TEXT[89];
			Link.l2.go = "node_20";
		...
		case "Node_18":
			if(makeint(PChar.money) >= 1)
			{
				...
				d.Text = DLG_TEXT[91] + Address_Form.Eng + DLG_TEXT[92];
				Link.l1 = DLG_TEXT[93];
				Link.l1.go = "node_21";
				Link.l2 = DLG_TEXT[94];
				Link.l2.go = "exit";
			...
			else
			{
				...
				d.Text = DLG_TEXT[95] + Pchar.name + DLG_TEXT[96];
				link.l1 = DLG_TEXT[97];
				link.l1.go = "Node_15";
			}
		...
		case "Node_19":
			...
			d.Text = DLG_TEXT[98] + Address_Form.eng + DLG_TEXT[99];
		...
		case "Node_20":
			...
			d.Text = DLG_TEXT[103] + Address_Form.Eng + DLG_TEXT[104];
		...
		case "Node_21":
			...
			d.Text = DLG_TEXT[107] + Address_Form.Eng;
		...
		case "Node_23":
			...
			d.Text = DLG_TEXT[115] + Address_Form.Eng + DLG_TEXT[116] + Address_Form.Eng + DLG_TEXT[117];
		...
		case "Node_24":
			...
			d.Text = DLG_TEXT[121] + Address_Form.Eng + DLG_TEXT[122];
		...
		case "Node_25":
			...
			RandQuestSum = RandSum("Few");
			d.Text = RandQuestSum  + DLG_TEXT[126] + Address_Form.Eng + DLG_TEXT[127];
		...
		case "Node_26":
			if(makeint(PChar.money)>=RandQuestSum)
			{
				...
				d.Text = DLG_TEXT[130] + Address_Form.Eng + DLG_TEXT[131];
		...
		case "Node_27":
			...
			d.Text = DLG_TEXT[137] + Address_Form.Eng + DLG_TEXT[138];
		...
		case "Node_29":
			...
			d.Text = RandPhrase(DLG_TEXT[143] + Address_Form.Eng + DLG_TEXT[144], DLG_TEXT[145], DLG_TEXT[146] + Address_Form.Eng + DLG_TEXT[147], &dialog, dialog.snd1, dialog.snd2, dialog.snd3);
		...
		case "node_30":
			if(makeint(PChar.money)>=1)
			{
				...
				d.Text = DLG_TEXT[150] + Address_Form.Eng + DLG_TEXT[151];
			...
			else
			{
				...
				d.Text = DLG_TEXT[154] + Pchar.name + DLG_TEXT[155];
		...
		case "Node_31":
			...
			d.Text = DLG_TEXT[157] + Address_Form.Eng + DLG_TEXT[158];
		...
		case "Node_32":
			...
			d.Text = DLG_TEXT[162] + Address_Form.Eng + DLG_TEXT[163];
		...
		case "Node_33":
			...
			d.Text = DLG_TEXT[166] + Address_Form.Eng + DLG_TEXT[167];
		...
		case "Node_34":
			...
			d.Text = DLG_TEXT[171] + Address_Form.Eng + DLG_TEXT[172];
		...
		case "Node_36":
			...
			d.Text = DLG_TEXT[179] + Address_Form.Eng + DLG_TEXT[180] + Address_Form.Eng + DLG_TEXT[181];
		...
		case "Node_37":
			...
			d.Text = DLG_TEXT[185] + Address_Form.Eng + DLG_TEXT[186];
