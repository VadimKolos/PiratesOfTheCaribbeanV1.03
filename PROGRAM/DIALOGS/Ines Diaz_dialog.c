//nclude "DIALOGS\Ines Diaz_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "quests":
			...
			if (CheckQuestAttribute("amanda_status", "searchAmandaInQC"))
			{
				link.l2 = "Я ищу капитана пиратского корабля 'Прозерпина', он не появлялся на этом острове?";
				link.l2.go = "portugalLineSearchA";
			}
		...
		case "portugalLineSearchA":
			Dialog.text = "Да, этот лягушатник иногда заходит на Кебрадас Костиллас. Вон Черный Ворон за тем столиком знает этого корсара.";
			Link.l1 = "Пойду поговорю с ним.";
			Link.l1.go = "talkExit";
			break;

		case "talkExit":
			AddDialogExitQuest("talkWithRaven");
			DialogExit();
			break;
	}
}
