...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Skip_tutorial_2":
			...
			link.l1.go = "Final_Goodbye_skip";				
		break;
		
		case "Final_Goodbye_skip":
			dialog.text = DLG_TEXT[219];
			link.l1 = DLG_TEXT[220];
			link.l1.go = "percent_skip";
			link.l2 = DLG_TEXT[221];
			link.l2.go = "Final_Goodbye_skip_2";
		break;
		...
		case "percent_skip":
			...
			link.l1.go = "Exit";				
			pchar.paymenttype = "percent";		
		break;

		case "Final_Goodbye_skip_2":
			NextDiag.Tempnode = "Questions";
		...
		case "Skip_TutorialInTown_1":
			...
			link.l1.go = "Suggestions";			
			link.l2 = DLG_TEXT[240];
			link.l2.go = "Ship_sailing";			
			link.l3 = DLG_TEXT[241];
			link.l3.go = "Final_Goodbye";			
		break;
		...
		case "BoardingShips":
			...
			link.l1.go = "CannonFire";			
			link.l2 = DLG_TEXT[252];
			link.l2.go = "Ship_sailing";			
			link.l3 = DLG_TEXT[253];
			link.l3.go = "Final_Goodbye";			
		break;
		...
		case "Questions":
			...
			link.l1.go = "Suggestions";			
			link.l2 = DLG_TEXT[263];
			link.l2.go = "Ship_sailing";			
			link.l3 = DLG_TEXT[264];
			link.l3.go = "Final_Goodbye";			
		break;
