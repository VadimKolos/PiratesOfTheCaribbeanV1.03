//nclude "DIALOGS\Oxbay citizen_dialog.h"
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if(NPChar.quest.meeting == "0")
			{
				...
				dialog.snd2 = "";
				dialog.snd3 = "";
				d.Text = RandPhrase(DLG_TEXT[0] + address_form.eng + DLG_TEXT[1] + NPChar.name + " " + NPChar.lastname + DLG_TEXT[2], DLG_TEXT[3] + address_form.eng + DLG_TEXT[4] + NPChar.name + " " + NPChar.lastname + DLG_TEXT[5], DLG_TEXT[6] + address_form.eng + DLG_TEXT[7] + NPChar.name + " " + NPChar.lastname + DLG_TEXT[8], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
			...
			else
			{
				...
				dialog.snd2 = "";
				dialog.snd3 = "";
				d.Text = RandPhrase(TimeGreeting() + DLG_TEXT[20] + PChar.name + DLG_TEXT[21], DLG_TEXT[22] + Pchar.name + DLG_TEXT[23], DLG_TEXT[24] + address_form.eng + " " + Pchar.lastname + DLG_TEXT[25], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
				if(Rand(1)==0)
				{
				...
				if(CheckQuestAttribute("Nigel_lost", "1"))
				{ 
					Link.l5 = DLG_TEXT[38] + Characters[GetCharacterIndex(DLG_TEXT[39])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[40])].lastname + DLG_TEXT[41];
					Link.l5.go = "Meeting1";
				}
		...
		case "Meeting":
			    if(NPChar.sex == "man")
			    {
					...
					dialog.snd2 = "";
					dialog.snd3 = "";
				   d.Text = RandPhrase(DLG_TEXT[45] + PChar.name + DLG_TEXT[46], DLG_TEXT[47] + address_form.eng + " " + PChar.lastname + DLG_TEXT[48], DLG_TEXT[49] + PChar.name + DLG_TEXT[50], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
				}
				else
				{
					dialog.snd1 = "";
					dialog.snd2 = "";
					dialog.snd3 = "";
				   d.Text = RandPhrase(DLG_TEXT[51] + PChar.name + DLG_TEXT[52], DLG_TEXT[53] + address_form.eng + " " + PChar.lastname + DLG_TEXT[54], DLG_TEXT[55] + PChar.name + DLG_TEXT[56], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
				}
				if(Rand(1)==0)
				{
		...
		case "new question":
			    if(NPChar.sex == "man")
			    {
					...
					dialog.snd2 = "";
					dialog.snd3 = "";
				    d.Text = RandPhrase(DLG_TEXT[72] + address_form.eng + " " + PChar.lastname + DLG_TEXT[73], DLG_TEXT[74] + address_form.eng + DLG_TEXT[75], DLG_TEXT[76], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3); 
				}
				else
				{
					dialog.snd1 = "";
					dialog.snd2 = "";
					dialog.snd3 = "";
				    d.Text = RandPhrase(DLG_TEXT[77] + address_form.eng + " " + PChar.lastname + DLG_TEXT[78], DLG_TEXT[79] + address_form.eng + DLG_TEXT[80], DLG_TEXT[81], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
				}
				if(Rand(1)==0)
				{
		...
		case "info":
				...
				dialog.snd2 = "";
				dialog.snd3 = "";
				d.Text = RandPhrase(DLG_TEXT[95] + address_form.eng + " " + PChar.lastname + DLG_TEXT[96], DLG_TEXT[97], DLG_TEXT[98], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
				if(Rand(1) == 0)
				{	
					Link.l1 = DLG_TEXT[99];
					Link.l1.go = "governor";
				...
				{
					Link.l2 = DLG_TEXT[108] + Characters[GetCharacterIndex(DLG_TEXT[109])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[110])].lastname + DLG_TEXT[111];
		...
		case "town":
			...
			dialog.snd2 = "";
			dialog.snd3 = "";
			d.Text = RandPhrase(DLG_TEXT[125] + Address_Form.eng + " " + PChar.lastname + DLG_TEXT[126], DLG_TEXT[127], DLG_TEXT[128] + Address_Form.eng + " " + PChar.lastname + DLG_TEXT[129], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
		...
		case "town_store":
			d.Text = DLG_TEXT[141] + address_form.eng + " " + PChar.name + DLG_TEXT[142];
