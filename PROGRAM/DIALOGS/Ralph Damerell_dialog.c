//nclude "DIALOGS\Ralph Damerell_dialog.h"
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if(NPChar.quest.meeting == "0")
			{
				...
				Link.l1 = RandPhrase(DLG_TEXT[9] + Pchar.name + " " + Pchar.lastname + DLG_TEXT[10] + PChar.Ship.name + DLG_TEXT[11], DLG_TEXT[12] + Pchar.name + " " + Pchar.lastname + DLG_TEXT[13], DLG_TEXT[14] + PChar.name + DLG_TEXT[15]);
				Link.l1.go = "Meeting";
			}
			else
			{
				if(NPChar.sex == "man")
				     d.Text = RandPhrase(DLG_TEXT[16] + PChar.name + DLG_TEXT[17], DLG_TEXT[18] + Pchar.name + " " + Pchar.lastname + DLG_TEXT[19], DLG_TEXT[20] + address_form.eng + " " + Pchar.lastname + DLG_TEXT[21]);
				else
				     d.Text = RandPhrase(DLG_TEXT[22] + PChar.name + DLG_TEXT[23], DLG_TEXT[24] + Pchar.name + " " + Pchar.lastname + DLG_TEXT[25], DLG_TEXT[26] + address_form.eng + " " + Pchar.lastname + DLG_TEXT[27]);                     
		...
		case "Meeting":
				d.Text = RandPhrase(DLG_TEXT[42], DLG_TEXT[43] + address_form.eng + " " + PChar.name + DLG_TEXT[44], DLG_TEXT[45] + PChar.name + DLG_TEXT[46]);
				if(Rand(1)==0)
				{
		...
		case "new question":
				d.Text = RandPhrase(DLG_TEXT[63] + address_form.eng + DLG_TEXT[64], DLG_TEXT[65] + address_form.eng + DLG_TEXT[66], DLG_TEXT[67]);
				if(Rand(1)==0)
				{
				...
				if(Rand(1)==0)	
				{
					Link.l2 = RandPhrase(DLG_TEXT[74], DLG_TEXT[75], DLG_TEXT[76]);
					Link.l2.go = "info";
				}
				else
				{
		...
		case "info":
				d.Text = RandPhrase(DLG_TEXT[81] + address_form.eng + DLG_TEXT[82], DLG_TEXT[83], DLG_TEXT[84] + address_form.eng + DLG_TEXT[85]);
				if(Rand(1)==0)
				{	
				...
				else
				{
					...
					Link.l1 = DLG_TEXT[87] + Characters[GetCharacterIndex(DLG_TEXT[88])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[89])].lastname + DLG_TEXT[90];
					Link.l1.go = "info_1";
				}
				if(Rand(1)==0)	
				{
					TempInfoCharacterID_2 = "David Fairweather";
					Link.l2 = DLG_TEXT[91] + Characters[GetCharacterIndex(DLG_TEXT[92])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[93])].lastname + DLG_TEXT[94];
					Link.l2.go = "info_2";
				}
				else 
				{
					TempInfoCharacterID_2 = "John  Filbert";
					Link.l2 = DLG_TEXT[95] + Characters[GetCharacterIndex(DLG_TEXT[96])].name + " " + Characters[GetCharacterIndex(DLG_TEXT[97])].lastname + DLG_TEXT[98];;
					Link.l2.go = "info_2";
				}
				Link.l3 = DLG_TEXT[99];
		...
		case "town":
			if(NPChar.sex == "man")
			   d.Text = RandPhrase(DLG_TEXT[104] + Address_Form.eng + " " + PChar.lastname + DLG_TEXT[105], DLG_TEXT[106], DLG_TEXT[107] + Address_Form.eng + DLG_TEXT[108]);
			else
			   d.Text = RandPhrase(DLG_TEXT[109] + Address_Form.eng + " " + PChar.lastname + DLG_TEXT[110], DLG_TEXT[111], DLG_TEXT[112] + Address_Form.eng + DLG_TEXT[113]);
		...
		case "colony":
			d.Text = RandPhrase(DLG_TEXT[129], DLG_TEXT[130], DLG_TEXT[131] + address_form.eng + " " + PChar.lastname + DLG_TEXT[132]);
			if(Rand(1)== 0)
			{
