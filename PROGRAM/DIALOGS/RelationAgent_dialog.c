...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Agreed":
			...
			switch(makeint(Pchar.quest.Relations.nation))
			{
				case ENGLAND:
					SetCharacterRelationBoth(GetCharacterIndex("Redmond Commander"),GetMainCharacterIndex(),RELATION_FRIEND);
					SetCharacterRelationBoth(GetCharacterIndex("Oxbay Commander"),GetMainCharacterIndex(),RELATION_FRIEND);
					SetCharacterRelationBoth(GetCharacterIndex("Greenford Commander"),GetMainCharacterIndex(),RELATION_FRIEND);
				break;
				
				case FRANCE:
					SetCharacterRelationBoth(GetCharacterIndex("FalaiseDeFleur Commander"),GetMainCharacterIndex(),RELATION_FRIEND);
				break;
				
				case SPAIN:
					SetCharacterRelationBoth(GetCharacterIndex("IslaMuelle Commander"),GetMainCharacterIndex(),RELATION_FRIEND);
				break;
				
				case HOLLAND:
					SetCharacterRelationBoth(GetCharacterIndex("Douwesen Commander"),GetMainCharacterIndex(),RELATION_FRIEND);
				break;
				
				case PORTUGAL:
					SetCharacterRelationBoth(GetCharacterIndex("Conceicao Commander"),GetMainCharacterIndex(),RELATION_FRIEND);
				break;
			}
		break;
