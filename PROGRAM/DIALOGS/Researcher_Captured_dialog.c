//nclude "DIALOGS\Researcher_Captured_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Talk_With_Blaze_1":
			...
			d.Text = DLG_TEXT[9] + Npchar.name + " " + Npchar.lastname + DLG_TEXT[10];
			Link.l1 = DLG_TEXT[11];
		...
		case "Talk_With_Blaze_2":
			...
			d.Text = DLG_TEXT[12];
			Link.l1 = DLG_TEXT[13] + Characters[GetCharacterIndex(DLG_TEXT[14])].name + DLG_TEXT[15] + Characters[GetCharacterIndex(DLG_TEXT[16])].lastname + DLG_TEXT[17];
