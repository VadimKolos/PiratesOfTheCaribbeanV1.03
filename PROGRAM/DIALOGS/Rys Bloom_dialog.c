...
//nclude "DIALOGS\Rys Bloom_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			Link.l1 = DLG_TEXT[2];
			Link.l1.go = "Exit";
			Link.l2 = DLG_TEXT[3] + PChar.name + DLG_TEXT[4];
			Link.l2.go = "node_2";
		break;
		...
		case "Node_2":
			...
			d.Text = "'" + PChar.ship.name + DLG_TEXT[5] + DLG_TEXT[6] + Address_Form.Eng + DLG_TEXT[7];
			Link.l1 = DLG_TEXT[8];
			Link.l1.go = "node_3";
			Link.l2 = DLG_TEXT[9];
			Link.l2.go = "Exit";
		...
		case "Node_3":
			...
			d.Text = DLG_TEXT[10] + Address_Form.Eng + " " + PChar.name +DLG_TEXT[11] + NPChar.name + DLG_TEXT[12];
			Link.l1 = DLG_TEXT[13];
			Link.l1.go = "Exit";
			Link.l2 = DLG_TEXT[14];
			Link.l2.go = "node_4";
		...
		case "Node_5":
			...
			d.Text = DLG_TEXT[18] + Address_Form.eng + DLG_TEXT[19];
			Link.l1 = DLG_TEXT[20];
			Link.l1.go = "Node_6";
			Link.l2 = DLG_TEXT[21];
			Link.l2.go = "node_7";
		...
		case "Node_6":
			...
			d.Text = DLG_TEXT[23] + address_form.eng + DLG_TEXT[24];
			Link.l1 = DLG_TEXT[25];
			Link.l1.go = "Node_8";
			Link.l2 = DLG_TEXT[26];
			Link.l2.go = "node_9";
		...
		case "Node_7":
			...
			Diag.TempNode = "Second time";
			d.Text = DLG_TEXT[27] + Address_Form.Eng + PChar.name + DLG_TEXT[28];
			Link.l1 = DLG_TEXT[29];
			Link.l1.go = "node_10";
			Link.l2 = DLG_TEXT[30];
			Link.l2.go = "exit";
...
//--------------------------Диалог 2: Игрок познакомился с Рисом, но отказался ему помочь.
		...
		case "Second time":
			...
			d.Text = RandPhrase(DLG_TEXT[41] + PChar.name + DLG_TEXT[42] + Address_Form.Eng + DLG_TEXT[43], DLG_TEXT[44] + Address_Form.Eng + PChar.name + DLG_TEXT[45], DLG_TEXT[46] + address_form.eng + DLG_TEXT[47], &Dialog, Dialog.snd1, Dialog.snd2, Dialog.snd3);
			Link.l1 = DLG_TEXT[48] + NPChar.name + DLG_TEXT[49];
			Link.l1.go = "Node_11";
			Link.l2 = DLG_TEXT[50];
			Link.l2.go = "exit";
		break;
		...
		case "Node_11":
			...
			d.Text = DLG_TEXT[51] + Address_Form.Eng + DLG_TEXT[52];
			Link.l1 = DLG_TEXT[53];
			Link.l1.go = "Node_12";
			Link.l2 = DLG_TEXT[54];
			Link.l2.go = "node_13";
		...
		case "Node_12":
			...
			d.Text = DLG_TEXT[56] + address_form.eng + DLG_TEXT[57];
			Link.l1 = DLG_TEXT[58];
			Link.l1.go = "Node_14";
			Link.l2 = DLG_TEXT[59];
			Link.l2.go = "node_15";
		...
		case "Node_13":
			...
			d.Text = DLG_TEXT[60] + Address_Form.Eng + " " + PChar.name + DLG_TEXT[61];
			Link.l1 = DLG_TEXT[62];
			Link.l1.go = "node_16";
			Link.l2 = DLG_TEXT[63];
			Link.l2.go = "exit";
...
//-------------------------Диалог 3 - Игрок поговорил с Блюмом, и согласился ему помочь.
		...
		case "Agreed_Help":
			...
			Diag.TempNode = "Agreed_help";
			d.Text = RandPhrase(DLG_TEXT[72] + PChar.name + DLG_TEXT[73] + Address_Form.Eng + DLG_TEXT[74], DLG_TEXT[75] + Address_Form.Eng + " " + PChar.name + DLG_TEXT[76], DLG_TEXT[77] + address_form.eng + DLG_TEXT[78], &Dialog, Dialog.snd1, Dialog.snd2, Dialog.snd3) + DLG_TEXT[79];
			Link.l1 = DLG_TEXT[80];
			Link.l1.go = "Node_17";
			Link.l2 = DLG_TEXT[81];
			Link.l2.go = "exit";
		...
		case "Node_17":
			...
			d.Text = DLG_TEXT[83] + address_form.eng + DLG_TEXT[84];
			Link.l1 = DLG_TEXT[85];
			Link.l1.go = "Node_18";
		...
		case "Node_18":
			...
			d.Text = DLG_TEXT[88] + address_form.eng + DLG_TEXT[89];
			Link.l1 = DLG_TEXT[90];
			Link.l1.go = "exit";
			Link.l2 = DLG_TEXT[91];
			Link.l2.go = "exit";
		...
		case "Node_19":
			...
			d.Text = DLG_TEXT[92] + Address_Form.eng + DLG_TEXT[93];
			Link.l1 = DLG_TEXT[94];
			Link.l1.go = "node_20";
			Link.l2 = DLG_TEXT[95];
			Link.l2.go = "exit";
		...
		case "Node_27":
			...
			d.Text = DLG_TEXT[116] + address_Form.eng + DLG_TEXT[117]; 
		...
		case "Node_29":
			...
			d.Text = DLG_TEXT[123] + address_form.eng + DLG_TEXT[124];
...
//-------------------------------Диалог 4 - если игроку не удалось уломать начальника порта. 
		...
		case "Help_Failed":
			...
			d.Text = RandPhrase(DLG_TEXT[127] + PChar.name + DLG_TEXT[128] + Address_Form.Eng + DLG_TEXT[129], DLG_TEXT[130] + Address_Form.Eng + PChar.name + DLG_TEXT[131], DLG_TEXT[132] + address_form.eng + DLG_TEXT[133], &Dialog, Dialog.snd1, Dialog.snd2, Dialog.snd3) + DLG_TEXT[134];
			Link.l1 = DLG_TEXT[135] + NPChar.name + DLG_TEXT[136];
			Link.l1.go = "Node_30";
		...
		case "Node_30":
			...
			d.Text = DLG_TEXT[138] + address_form.eng + DLG_TEXT[139];
			Link.l1 = DLG_TEXT[140] + NPChar.name + DLG_TEXT[141];
			Link.l1.go = "Node_18";
			if(NPChar.quest.dialog == "0") {
...
//-------------------------------Диалог 4 - игроку удалось уговорить начальника порта . 
		...
		case "Help_succesful_1":
			...
			Diag.TempNode = "common";
			d.Text = DLG_TEXT[147] + address_form.eng + DLG_TEXT[148];
			Link.l1 = DLG_TEXT[149];
			Link.l1.go = "Help_succesful_2";
			AddPartyExp(pchar, 450);
		break;
		...
		case "Help_succesful_2":
			...
			Link.l2 = DLG_TEXT[152] + NPChar.name + DLG_TEXT[153];
			Link.l2.go = "exit";
		break;
		...
		case "Help_succesful_3":
			...
			Link.l1 = DLG_TEXT[156] + NPChar.name + DLG_TEXT[157];
			Link.l1.go = "exit";
		...
		case "hire":
			dialog.text = DLG_TEXT[160] + address_form.eng + DLG_TEXT[161];
...
//-------------------------------Диалог 5 - обычный диалог. 
		...
		case "common":
			...
			Link.l1 = DLG_TEXT[167] + NPChar.name + DLG_TEXT[168];
			Link.l1.go = "node_20";
