	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Exchange":
			...
			if(FindFirstContrabandGoods(Pchar) != -1)
			{
				...
				Pchar.quest.Contraband.Sum = makeint(Pchar.quest.Contraband.price1)*GetSquadronGoods(Pchar,makeint(Pchar.quest.Contraband.goodsIDX1)) + makeint(Pchar.quest.Contraband.price2)*GetSquadronGoods(Pchar,makeint(Pchar.quest.Contraband.goodsIDX2)) + makeint(Pchar.quest.Contraband.price3)*GetSquadronGoods(Pchar,makeint(Pchar.quest.Contraband.goodsIDX3));
