//nclude "DIALOGS\Wilfred_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			d.Text = DLG_TEXT[0] + PChar.name + DLG_TEXT[1];
			Link.l1 = DLG_TEXT[2];
			Link.l1.go = "Node_1";
		break;
		...
		case "Node_1":
			...
			d.Text = DLG_TEXT[3] + NPChar.name + DLG_TEXT[4];
		...
		case "Node_2":
			...
			d.Text = DLG_TEXT[7] + address_form.eng + DLG_TEXT[8] + PChar.name + DLG_TEXT[9];
			Link.l1 = DLG_TEXT[10];
			Link.l1.go = "Node_3";
		break;
		...
		case "node_4":
			...
			d.Text = DLG_TEXT[13] + address_form.eng + DLG_TEXT[14];
			Link.l1 = DLG_TEXT[15];
			Link.l1.go = "Node_5";
		break;
		...
		case "Node_5":
			...
			d.text = DLG_TEXT[16] + address_form.eng + DLG_TEXT[17];
			Link.l1 = DLG_TEXT[18];
			Link.l1.go = "node_6";
		break;
		...
		case "Node_6":
			...
			d.Text = DLG_TEXT[19] + address_form.eng + DLG_TEXT[20];
			Link.l1 = DLG_TEXT[21];
			Link.l1.go = "Node_7";
		break;
		...
		case "Node_7":
			...
			d.Text =   DLG_TEXT[22] + address_form.eng + DLG_TEXT[23];
			Link.l1 = DLG_TEXT[24] + NPChar.name + DLG_TEXT[25];
			Link.l1.go = "exit";
		...
		case "Second Time":
			...
			Link.l1 = DLG_TEXT[32] + NPchar.name + DLG_TEXT[33];
			Link.l1.go = "exit";
			AddDialogExitQuest("Wilfred_exit_failed");
		break;
		...
		case "Warning":
			...
			D.text = DLG_TEXT[34] + Pchar.name + DLG_TEXT[35];
			Link.l1 = DLG_TEXT[36];
		...
		case "Victory_2":
			...
			d.Text = DLG_TEXT[43] + address_form.eng + DLG_TEXT[44];
			Link.l1 = DLG_TEXT[45];
		...
		case "Victory_3":
			...
			d.text = DLG_TEXT[46] + address_form.eng + DLG_TEXT[47];
			Link.l1 = DLG_TEXT[48];
		...
		case "Victory_4":
			...
			d.text = DLG_TEXT[49] + Address_form.eng + DLG_TEXT[50];
			Link.l1	= DLG_TEXT[51];
			Link.l1.go = "exit";
