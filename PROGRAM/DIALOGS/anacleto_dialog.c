//nclude "DIALOGS\anacleto_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "prepare_convoy_quest_3":
			...
			dialog.text = DLG_TEXT[30] + LanguageConvertString(g_LocLngFileID, locations[FindLocation(pchar.quest.destination)].id.label) + DLG_TEXT[31] + pchar.quest.convoymoney + DLG_TEXT[32];
			link.l1 = DLG_TEXT[33];
