//nclude "DIALOGS\andre juliao_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "contraband":
			...
			link.l1 = pcharrepphrase(characters[GetCharacterIndex(DLG_TEXT[9])].name + " " + characters[GetCharacterIndex(DLG_TEXT[10])].lastname + DLG_TEXT[11], DLG_TEXT[12] + characters[GetCharacterIndex(DLG_TEXT[13])].name + " " + characters[GetCharacterIndex(DLG_TEXT[14])].lastname + DLG_TEXT[15]);
		...
		case "contraband_1":
			...
			AddQuestRecord("Thomas_O'Reily_contraband", "5");
		break;
