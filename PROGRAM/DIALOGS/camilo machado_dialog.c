...
//nclude "DIALOGS\camilo machado_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "smuggler_line":
			...
			if (CheckQuestAttribute("smuggler_line", "to_machado"))
			{
			...
			if (CheckQuestAttribute("smuggler_line", "smuggler_line_first_mission_soldiers_arrest_matton"))
			{
				dialog.text = DLG_TEXT[42];
				link.l1 = DLG_TEXT[43];
				link.l1.go = "smuggler_line_first_mission_soldiers_arrest_matton";
			}
			if (CheckQuestAttribute("smuggler_line", "second_mission_to_machado_with_money_and_with_ring") && makeint(pchar.money)>=10000)
			{
				dialog.text = DLG_TEXT[44];
				link.l1 = DLG_TEXT[45];
				link.l1.go = "second_mission_to_machado_with_money_and_with_ring";
			}
			if (CheckQuestAttribute("smuggler_line", "second_mission_return_to_machado_after_prison"))
			{
				dialog.text = DLG_TEXT[46];
				link.l1 = DLG_TEXT[47];
				link.l1.go = "second_mission_return_to_machado_after_prison";
			}
			...
			if (CheckQuestAttribute("smuggler_line", "second_mission_truth_to_matton"))
			{
				dialog.text = DLG_TEXT[50];
				link.l1 = DLG_TEXT[51];
				link.l1.go = "second_mission_truth_to_matton";
			}
			...
			if (CheckQuestAttribute("smuggler_line", "fourth_mission_meet_with_arnaud_in_tavern_good") || CheckQuestAttribute("smuggler_line", "fourth_mission_ring_completed"))
			{
				dialog.text = DLG_TEXT[60];
				link.l1 = DLG_TEXT[61];
				link.l1.go = "fourth_mission_completed";
			}
			if (CheckQuestAttribute("smuggler_line", "fourth_mission_kill_arnaud"))
			{
				dialog.text = DLG_TEXT[62];
				link.l1 = DLG_TEXT[63];
				link.l1.go = "fourth_mission_kill_arnaud";
			}
			...
			if (CheckQuestAttribute("smuggler_line", "fourth_mission_return_to_machado"))
			{
		...
		case "first_mission_9":
			dialog.text = DLG_TEXT[104] + pchar.name + DLG_TEXT[105];
		...
		case "smuggler_line_first_mission_soldiers_arrest_matton":
			...
			link.l1.go = "smuggler_line_first_mission_soldiers_arrest_matton_2";
		break;
		
		case "smuggler_line_first_mission_soldiers_arrest_matton_2":
			dialog.text = DLG_TEXT[121];
			link.l1 = DLG_TEXT[122];
			link.l1.go = "smuggler_line_first_mission_soldiers_arrest_matton_3";
		break;
		
		case "smuggler_line_first_mission_soldiers_arrest_matton_3":
		...
		case "second_mission_to_machado_with_money_and_with_ring":
			dialog.text = DLG_TEXT[136];
			link.l1 = DLG_TEXT[137];
			link.l1.go = "second_mission_to_machado_with_money_and_with_ring_2";
		break;
		
		case "second_mission_to_machado_with_money_and_with_ring_2":
			dialog.text = DLG_TEXT[138];
			link.l1 = DLG_TEXT[139];
			link.l1.go = "second_mission_to_machado_with_money_and_with_ring_3";
		break;
		
		case "second_mission_to_machado_with_money_and_with_ring_3":
			dialog.text = DLG_TEXT[140];
			link.l1 = DLG_TEXT[141];
			link.l1.go = "third_mission";
			AddDialogExitQuest("second_mission_money_delivered_to_machado");
		break;
		
		case "second_mission_return_to_machado_after_prison":
			dialog.text = DLG_TEXT[142];
			link.l1 = DLG_TEXT[143];
			link.l1.go = "second_mission_return_to_machado_after_prison_2";
		break;
		
		case "second_mission_return_to_machado_after_prison_2":
			dialog.text = DLG_TEXT[144];
			link.l1 = DLG_TEXT[145];
			link.l1.go = "third_mission";
			AddDialogExitQuest("second_mission_money_not_delivered_to_machado");
		break;
		...
		case "second_mission_after_fight_with_killers_2":
			...
			link.l1.go = "third_mission";
			AddDialogExitQuest("second_mission_after_fight_with_killers_return_to_machado");
		break;
		
		case "second_mission_truth_to_matton":
			dialog.text = DLG_TEXT[150];
			link.l1 = DLG_TEXT[151];
			link.l1.go = "second_mission_truth_to_matton_2";
		break;
		...
		case "second_mission_truth_to_matton":
			...
			link.l1.go = "third_mission";
			AddDialogExitQuest("second_mission_truth_to_matton_and_say_machado");
		break;
		...
		case "third_mission_2":
			dialog.text = DLG_TEXT[160] + GetCharacterFullName(DLG_TEXT[161]) + DLG_TEXT[162];
		...
		case "fourth_mission_kill_arnaud":
			if (checkQuestAttribute("smuggler_line.second_mission", "completed") || checkQuestAttribute("smuggler_line.third_mission", "completed"))
			{
				...
				link.l1.go = "fourth_mission_kill_arnaud_2";
			}
			else
			{
				dialog.text = DLG_TEXT[189];
				link.l1 = DLG_TEXT[190];
				link.l1.go = "fourth_mission_kill_arnaud_fire_fight";
				link.l2 = DLG_TEXT[191];
				link.l2.go = "fourth_mission_kill_arnaud_fire_without_fight";
			}
		break;
		
		case "fourth_mission_kill_arnaud_2":
		...
		case "fourth_mission_kill_arnaud_fire_fight":
			...
			link.l1.go = "exit";
			AddDialogExitQuest("fourth_mission_kill_arnaud_fire_fight");
		break;
		...
		case "fourth_mission_kill_arnaud_fire_without_fight":
			...
			link.l1.go = "exit";
			AddDialogExitQuest("fourth_mission_kill_arnaud_fire_without_fight");
		break;
		...
		case "trap_completed_3":
			...
			link.l1.go = "exit";
			AddDialogExitQuest("smugler_line_completed");
		break;
