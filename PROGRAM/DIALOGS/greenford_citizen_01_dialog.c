//nclude "DIALOGS\greenford_citizen_01_dialog.h"
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (pchar.quest.main_line == "to_oxbay_by_prisoner_escape")
			{
				...
				Dialog.Text = DLG_TEXT[2] + address_form.eng + DLG_TEXT[3];
				Link.l1 = DLG_TEXT[4];
		...
		case "researcher_9":
			...
			dialog.text = DLG_TEXT[19] + characters[GetCharacterIndex(DLG_TEXT[20])].name + DLG_TEXT[21];
