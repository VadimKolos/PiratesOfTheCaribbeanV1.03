//nclude "DIALOGS\lucien bescanceny_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				Link.l1 = DLG_TEXT[1] + NPChar.name + DLG_TEXT[2];
				Link.l1.go = "node_1";
			}
			else
			{
		...
		case "node_1":
			...
			Link.l1 = NPChar.Name + DLG_TEXT[5];
			Link.l1.go ="node_2";
		break;
		...
		case "node_4":
			...
			Link.l1 = DLG_TEXT[11];
			Link.l1.go = "node_5";
			Link.l2 = DLG_TEXT[12] + NPChar.name + DLG_TEXT[13];
			Link.l2.go = "node_6";
		break;
		...
		case "node_5_3":
			...
			Link.l1 = DLG_TEXT[21];
			Link.l1.go = "node_5_4";
			Link.l2 = DLG_TEXT[22] + Npchar.name + DLG_TEXT[23];
			Link.l2.go = "node_6";
		break;
