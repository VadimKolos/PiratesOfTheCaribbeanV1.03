//nclude "DIALOGS\mine commander_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				link.l1 = DLG_TEXT[4] + characters[GetCharacterIndex(DLG_TEXT[5])].name + " " + characters[GetCharacterIndex(DLG_TEXT[6])].lastname + DLG_TEXT[7];
		...
		case "soldier_to_mine_commander_resque_2":
			...
			link.l1 = DLG_TEXT[16] + pchar.name + " " + pchar.lastname + DLG_TEXT[17];
		...
		case "resque_leborio":
			...
			link.l1 = DLG_TEXT[42] + characters[GetCharacterIndex(DLG_TEXT[43])].name + " " + characters[GetCharacterIndex(DLG_TEXT[44])].lastname + DLG_TEXT[45];
