//nclude "DIALOGS\raoul calmes_dialog.h"
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (npchar.quest.visit == "1")
			{
				...
				Link.l1 = DLG_TEXT[3] + Characters[GetCharacterIndex(DLG_TEXT[4])].name + DLG_TEXT[5];
				Link.l1.go = "node_1";
			}
		...
		case "node_1":
			dialog.text = DLG_TEXT[10] + Characters[GetCharacterIndex(DLG_TEXT[11])].name + DLG_TEXT[12];
			link.l1 = DLG_TEXT[13];
			link.l1.go = "node_2";
		break;
		...
		case "node_2":
			...
			link.l1 = DLG_TEXT[15] + Characters[GetCharacterIndex(DLG_TEXT[16])].name + DLG_TEXT[17];
			link.l1.go = "node_3";
		break;
		...
		case "node_7":
			...
			link.l1 = DLG_TEXT[27] + pchar.name + " " + pchar.lastname + DLG_TEXT[28];
			link.l1.go = "node_8";
		break;
		...
		case "right_7":
			...
			link.l1 = DLG_TEXT[63] + pchar.name + " " + pchar.lastname + DLG_TEXT[64];
			link.l1.go = "right_8";
		break;
