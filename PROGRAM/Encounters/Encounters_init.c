...
void InitEncounters()
{
	...
	// small merchant
		...
		Enc_AddClasses(rEnc, 20,3, 4, 0, 0);
		Enc_AddClasses(rEnc, 30,3, 4, 0, 0);
	...
	// 
		...
		Enc_AddClasses(rEnc, 20,3, 4, 2, 3);
		Enc_AddClasses(rEnc, 30,3, 4, 1, 2);
	...
	// 
		...
		Enc_AddClasses(rEnc, 9, 3, 5, 2, 4);
		Enc_AddClasses(rEnc, 10,3, 5, 2, 4);
		Enc_AddClasses(rEnc, 20,3, 5, 1, 3)
		Enc_AddClasses(rEnc, 30,3, 4, 1, 2)
		
	// 
		makeref(rEnc, EncountersTypes[ENCOUNTER_TYPE_MERCHANT3]);	// 1 + 3
		rEnc.Type = ENCOUNTER_TRADE;
		rEnc.MinRank = 8;
		Enc_AddShips(rEnc, "Merchant", 2, 3);
		Enc_AddShips(rEnc, "War", 2, 3);
		...
		Enc_AddClasses(rEnc, 8, 4, 5, 2, 4);
		Enc_AddClasses(rEnc, 9, 4, 5, 2, 4);
		Enc_AddClasses(rEnc, 10, 3, 4, 2, 4);
		Enc_AddClasses(rEnc, 11, 3, 4, 2, 4);
		Enc_AddClasses(rEnc, 12, 3, 4, 2, 3);
		Enc_AddClasses(rEnc, 13, 3, 4, 2, 3);
		Enc_AddClasses(rEnc, 14,3, 4, 2, 3);
		Enc_AddClasses(rEnc, 20,3, 4, 1, 3);
		Enc_AddClasses(rEnc, 30,3, 4, 1,2);
		
		makeref(rEnc, EncountersTypes[ENCOUNTER_TYPE_MERCHANT4]);	// 3 + 0
		rEnc.Type = ENCOUNTER_TRADE;
		rEnc.MinRank = 1;
		Enc_AddShips(rEnc, "Merchant", 1, 3);
		Enc_ExcludeNation(rEnc, PIRATE);
		...
		Enc_AddClasses(rEnc, 3, 4, 6, 0, 0);
		Enc_AddClasses(rEnc, 4, 4, 6, 0, 0);
		Enc_AddClasses(rEnc, 5, 4, 6, 0, 0);
		Enc_AddClasses(rEnc, 6, 4, 6, 0, 0);
		Enc_AddClasses(rEnc, 7, 4, 6, 0, 0);
		Enc_AddClasses(rEnc, 8, 4, 6, 0, 0);
		Enc_AddClasses(rEnc, 9, 4, 6, 0, 0);
		Enc_AddClasses(rEnc, 10,4, 6, 0, 0);
		Enc_AddClasses(rEnc, 20,4, 6, 0, 0);
		Enc_AddClasses(rEnc, 30,4, 6, 0, 0);
	...
	// ======================== WAR ENCOUNTERS ========================
		...
		Enc_AddClasses(rEnc, 10,0, 0, 2, 3);
		Enc_AddClasses(rEnc, 20,0, 0, 2, 3);
		Enc_AddClasses(rEnc, 30,0, 0, 2, 3);
	...
	// 
		makeref(rEnc, EncountersTypes[ENCOUNTER_TYPE_FLEET2]);	// 0 + 4
		rEnc.Type = ENCOUNTER_WAR;
		rEnc.MinRank = 8;
		...
		Enc_AddClasses(rEnc, 11, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 12, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 13,0, 0, 1, 1);
		Enc_AddClasses(rEnc, 20,0, 0, 1, 1);
		Enc_AddClasses(rEnc, 30,0, 0, 1, 1);
		
	// 
		makeref(rEnc, EncountersTypes[ENCOUNTER_TYPE_FLEET3]);	// 0 + 4
		rEnc.Type = ENCOUNTER_WAR;
		rEnc.MinRank = 10;
		Enc_AddShips(rEnc, "War", 4, 6);
		Enc_ExcludeNation(rEnc, PIRATE);

		Enc_AddClasses(rEnc, 10, 0, 0, 1, 3);
		Enc_AddClasses(rEnc, 11, 0, 0, 1, 3);
		Enc_AddClasses(rEnc, 12, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 13, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 14, 0, 0, 1, 1);
		Enc_AddClasses(rEnc, 15,0, 0, 1, 1);
		Enc_AddClasses(rEnc, 20,0, 0, 1, 1);
		Enc_AddClasses(rEnc, 30,0, 0, 1, 1);
	...
	// 
		...
		Enc_AddClasses(rEnc, 20,0, 0, 2, 4);
	...
	// 
		...
		Enc_AddClasses(rEnc, 3, 0, 0, 5, 6);
		Enc_AddClasses(rEnc, 10, 0, 0, 5, 6);
		Enc_AddClasses(rEnc, 20, 0, 0, 5, 6);
		Enc_AddClasses(rEnc, 30, 0, 0, 5, 6);
		
	// 
		makeref(rEnc, EncountersTypes[ENCOUNTER_TYPE_PIRATE2]);	// 0 + 2
		...
		Enc_AddClasses(rEnc, 8, 0, 0, 3, 4);
		Enc_AddClasses(rEnc, 9, 0, 0, 3, 3);
		Enc_AddClasses(rEnc, 10, 0, 0, 3, 3);
		Enc_AddClasses(rEnc, 20, 0, 0, 3, 3);
		Enc_AddClasses(rEnc, 30, 0, 0, 3, 3);
	...
	// Punitive squadron
		...
		Enc_AddClasses(rEnc, 10, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 11, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 12, 0, 0, 1, 1);
		Enc_AddClasses(rEnc, 20, 0, 0, 1, 1);
		Enc_AddClasses(rEnc, 30, 0, 0, 1, 1);
		
		makeref(rEnc, EncountersTypes[ENCOUNTER_TYPE_ARMADA]);	// 0 + 4
		rEnc.Type = ENCOUNTER_WAR;
		rEnc.MinRank = 10;
		Enc_AddShips(rEnc, "War", 6, 8);
		Enc_ExcludeNation(rEnc, PIRATE);

		Enc_AddClasses(rEnc, 20, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 21, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 22, 0, 0, 1, 2);
		Enc_AddClasses(rEnc, 23, 0, 0, 1, 1);
		Enc_AddClasses(rEnc, 24, 0, 0, 1, 1);
		Enc_AddClasses(rEnc, 25,0, 0, 1, 1);
		Enc_AddClasses(rEnc, 30,0, 0, 1, 1);
