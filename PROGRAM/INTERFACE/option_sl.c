...
void PrepareDefaultOption(ref optref)
{
	...
	optref.arcademode.arcade_sailing = true;
	optref.arcademode.arcade_fencing = true;
	optref.arcademode.arcade_cannons = true;
...
void GetRealOptions(ref optref)
{
	...
	optref.arcademode.arcade_sailing = bArcadeSailing;
	optref.arcademode.arcade_fencing = bArcadeFencing;
	optref.arcademode.arcade_cannons = bArcadeCannons;
...
void SetCurentOptions(ref optref)
{
	...
	bArcadeSailing = sti(optref.arcademode.arcade_sailing);
	bArcadeFencing = sti(optref.arcademode.arcade_fencing);
	bArcadeCannons = sti(optref.arcademode.arcade_cannons);
