void InitItems()
{
	...
	makeref(itm,Items[n]);
	itm.id = "Shotgun";
	itm.name = "itmname_shotgun";
	itm.describe = "itmdescr_shotgun";
	itm.folder = "items";
	itm.model = "sqitem";
	itm.picIndex = 9;
	itm.picTexture = "ITEMS_1";
	//itm.shown = 1;
	//itm.startLocation = "labirint_1";
	//itm.startLocator = "randitem8";
	itm.quest = "onuseshotgun";
	...
	makeref(itm,Items[n]);
	itm.id = "shop_papers";
	itm.name = "itmname_shop_papers";
	itm.describe = "itmdescr_shop_papers";
	itm.model = "";
	itm.picIndex = 3;
...
//	itm.shown = 0;
	...
	makeref(itm,Items[n]);
	itm.id = "Ear";
	itm.name = "itmname_ear";
	itm.describe = "itmdescr_ear";
	itm.picIndex = 2;
	itm.picTexture = "ITEMS_1";
//	itm.shown = false;
	itm.minlevel = 0;
	...
	makeref(itm,Items[n]);
	itm.id = "Anchor";
	itm.name = "itmname_anchor";
	itm.describe = "itmdescr_anchor";
	itm.picIndex = 8;
	itm.picTexture = "ITEMS_1";
//	itm.shown = false;
	itm.minlevel = 0;
...
//QUEST ITEMS
	...
	makeref(itm,Items[n]);
	itm.id = "Arnaud_ring";
	itm.name = "itmname_Arnaud_ring";
	itm.describe = "itmdescr_Arnaud_ring";
	itm.model = "";
	itm.picIndex = 7;
