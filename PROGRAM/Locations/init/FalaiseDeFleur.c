...
/*	Locations[n].reload.l3.name = "sea";
	...
	Locations[n].reload.l4.name = "locator21";
	Locations[n].reload.l4.go = "FDF_prison";
	Locations[n].reload.l4.emerge = "reload1";
	Locations[n].reload.l4.autoreload = "0";
	Locations[n].reload.l4.label = "Falaise de Fleur prison";
	n = n + 1;
...
//	locations[n].fastreload = "Falaise_De_Fleur";
	...
	n = n + 1;
	 ...
	 //  -------------------------------------------------
	Locations[n].id = "FDF_prison";
	locations[n].id.label = "Falaise de Fleur prison";
