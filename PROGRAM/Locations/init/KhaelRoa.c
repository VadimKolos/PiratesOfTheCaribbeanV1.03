...
int LocationInitKhaelRoa(int n)
{
	...
	Locations[n].image = "loading\Khael_Roa_Shore.tga";
	locations[n].id.label = "Khael Roa Shore";
	//Sound
	...
	Locations[n].image = "loading\Khael_Roa_Temple.tga";
	...
	//Sound
	Locations[n].image = "loading\Khael_Roa_Maze1.tga";
	locations[n].type = "inca_temple";
	locations[n].id.label = "Maze";
	
	locations[n].items.randitem8 = "shotgun";
	//Models
	//Always
	Locations[n].models.always.locators = "lab1_l";
	Locations[n].models.always.locators1 = "labloc";
...
/*	Locations[n].reload.l1.name = "reload27";
	...
	Locations[n].filespath.models = "locations\Incas Temple\Labirint\";
	//Sound
		Locations[n].image = "loading\Khael_Roa_Maze2.tga";
	locations[n].type = "inca_temple";
	locations[n].id.label = "Maze";
	//Models
	//Always
...
/*	Locations[n].reload.l4.name = "reload18";
	...
	Locations[n].filespath.models = "locations\Incas Temple\Labirint\";
	//Sound
		Locations[n].image = "loading\Khael_Roa_Maze3.tga";
	locations[n].type = "inca_temple";
	locations[n].id.label = "Maze";
	//Models
	//Always
	...
	//Sound
	Locations[n].image = "loading\Khael_Roa_Alcove.tga";
	locations[n].type = "inca_temple";
