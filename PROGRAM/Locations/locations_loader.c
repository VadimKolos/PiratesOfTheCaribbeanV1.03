...
bool LoadLocation(ref loc)
{
	...
	loadedLocation = loc;
	/*if (loc.id == "labirint_1")
	{
		loc.locators.item.randitem9.x = 80.0;
		loc.locators.item.randitem9.y = 0.04;
		loc.locators.item.randitem9.z = -17.4;
		loc.locators.item.randitem9.vx.x = 3;
		loc.locators.item.randitem9.vx.y = 0;
		loc.locators.item.randitem9.vx.z = 0;
		loc.locators.item.randitem9.vy.x = 0;
		loc.locators.item.randitem9.vy.y = 3;
		loc.locators.item.randitem9.vy.z = 0;
		loc.locators.item.randitem9.vz.x = 0;
		loc.locators.item.randitem9.vz.y = 0;
		loc.locators.item.randitem9.vz.z = 3;
		loc.locators.radius = 1.0;
