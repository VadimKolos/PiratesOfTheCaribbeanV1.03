...
// Day storm, 7 - 17 hour
	...
	Weathers[n].Sea.Harmonics.h1 = "0.0,10.0,0.1202,80.87,-68.00";
	Weathers[n].Sea.Harmonics.h2 = "1.57,10.0,2.1002,82.28,88.00";
	Weathers[n].Sea.Harmonics.h3 = "0.47,12.0,2.2002,82.28,68.00";
	Weathers[n].Sea.Harmonics.h4 = "0.27,47.0,0.0502,82.28,288.00";
	Weathers[n].Sea.Harmonics.h5 = "1.27,57.0,0.0702,82.28,188.00";
	Weathers[n].Sea.Harmonics.h6 = "2.27,57.0,0.0302,82.28,88.00";
	Weathers[n].Sea.Harmonics.h7 = "2.27,7.0,3.1402,82.28,188.00";
	Weathers[n].Sea.Harmonics.h8 = "22.77,17.0,0.0502,82.28,288.00";
	Weathers[n].Sea.Harmonics.h9 = "1.77,17.0,0.1002,82.28,188.00";
	Weathers[n].Sea.Harmonics.h10 = "34.0,14.0,0.5002,82.28,128.00";
	Weathers[n].Sea.Harmonics.h11 = "134.0,4.0,5.5002,82.28,110.00";
	
	Weathers[n].Wind.Angle = 123.59;
	Weathers[n].Wind.Speed.Min = 16.0;
