...
// evening, after rain, 17 - 21 hour
	...
	// evening, after rain, 17 - 21 hour
	Weathers[n].id = "Evening After Rain_10";
	...
	Weathers[n].Sea.Harmonics.h2 = "1.57,8.0,0.70002,82.28,68.00";
	Weathers[n].Sea.Harmonics.h3 = "0.77,20.0,0.3002,82.28,128.00";
	Weathers[n].Sea.Harmonics.h4 = "1.27,22.0,0.2402,82.28,128.00";
	Weathers[n].Sea.Harmonics.h5 = "2.10,5.0,2.1002,82.28,28.00";

	Weathers[n].Wind.Angle = 42.0;
	Weathers[n].Wind.Speed.Min = 11.0;
	Weathers[n].Wind.Speed.Max = 13.5;
...
// evening, red sky, 19 - 22 hour
	...
	Weathers[n].Sea.SunRoad.Color2 = argb(0,255,128,55);
	Weathers[n].Sea.SunRoad.Power = 2.0;
	Weathers[n].Sea.Harmonics.h1 = "0.0,10.0,1.2202,80.87,-128.00";
	Weathers[n].Sea.Harmonics.h2 = "1.57,8.0,1.10002,82.28,68.00";
	Weathers[n].Sea.Harmonics.h3 = "0.77,20.0,0.9002,82.28,128.00";
	Weathers[n].Sea.Harmonics.h4 = "1.27,12.0,1.1402,82.28,128.00";

	Weathers[n].Wind.Angle = 26.4;
...
// evening, crimson sky, 17 - 21 hour
	...
	Weathers[n].Sea.SunRoad.Color2 = argb(0,255,200,55);
	Weathers[n].Sea.SunRoad.Power = 3.0;
	Weathers[n].Sea.Harmonics.h1 = "0.0,8.0,1.4202,80.87,-48.00";
	Weathers[n].Sea.Harmonics.h2 = "1.57,10.0,1.4002,82.28,48.00";
	Weathers[n].Sea.Harmonics.h3 = "0.27,5.0,1.4002,82.28,48.00";

	Weathers[n].Wind.Angle = 12.7;
	Weathers[n].Wind.Speed.Min = 8.2;
	Weathers[n].Wind.Speed.Max = 12.0;
