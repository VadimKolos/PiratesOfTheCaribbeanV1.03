...
// morning 5 - 10 hour
	...
	Weathers[n].Sea.SunRoad.Color2 = argb(0,255,100,0);
	Weathers[n].Sea.SunRoad.Power = 3.0;
	Weathers[n].Sea.Harmonics.h1 = "10.0,10.0,0.0802,80.87,-48.00";
	Weathers[n].Sea.Harmonics.h2 = "0.57,12.0,0.3402,82.28,48.00";
	Weathers[n].Sea.Harmonics.h3 = "1.57,7.0,0.6902,82.28,48.00";
	Weathers[n].Sea.Harmonics.h4 = "1.0,12.0,0.0402,82.28,48.00";
	Weathers[n].Sea.Harmonics.h5 = "3.27,4.0,0.6402,82.28,48.00";
	Weathers[n].Sea.Harmonics.h6 = "3.27,2.0,1.2402,82.28,48.00";
	Weathers[n].Sea.Harmonics.h7 = "3.47,4.0,2.5402,82.28,48.00";

	Weathers[n].Wind.Angle = 2.5;
	Weathers[n].Wind.Speed.Min = 6.0;
	Weathers[n].Wind.Speed.Max = 10.0;
	
	n++;
	
	Weathers[n].id = "Morning_20";
	...
	Weathers[n].Fog.Enable = true;
	Weathers[n].Fog.Height = 5000.0;
	Weathers[n].Fog.Start = 0.0;
	Weathers[n].Fog.Density = 0.2;
	Weathers[n].Fog.SeaDensity = 0.14;
	Weathers[n].Fog.Color = argb(0,225,222,222);
	
	Weathers[n].SpecialSeaFog.Enable = true;
	Weathers[n].SpecialSeaFog.Height = 5000.0;
	Weathers[n].SpecialSeaFog.Start = 0.0;
	Weathers[n].SpecialSeaFog.Density = 0.025;
	Weathers[n].SpecialSeaFog.SeaDensity = 0.015;
	Weathers[n].SpecialSeaFog.Color = argb(0,225,222,222);
	...
	Weathers[n].Sea.Harmonics.h5 = "3.27,4.0,0.6402,82.28,48.00";
	Weathers[n].Sea.Harmonics.h6 = "3.27,2.0,1.2402,82.28,48.00";
	Weathers[n].Sea.Harmonics.h7 = "3.47,4.0,3.5402,82.28,48.00";
