...
// night, 23 - 7 hour
	...
	Weathers[n].Sea.SunRoad.Color2 = argb(0,255,255,255);
	Weathers[n].Sea.SunRoad.Power = 3.0;
	Weathers[n].Sea.Harmonics.h1 = "0.0,10.0,0.8202,80.87,-48.00";
	Weathers[n].Sea.Harmonics.h2 = "1.57,10.0,1.2002,82.28,28.00";
	Weathers[n].Sea.Harmonics.h3 = "0.27,5.0,0.2002,82.28,48.00";
	Weathers[n].Sea.Harmonics.h4 = "5.27,7.0,2.2002,82.28,38.00";
	Weathers[n].Sea.Harmonics.h5 = "5.27,3.0,1.2002,82.28,38.00";

	Weathers[n].Wind.Angle = 140.0;
	Weathers[n].Wind.Speed.Min = 5.0;
	Weathers[n].Wind.Speed.Max = 7.0;
